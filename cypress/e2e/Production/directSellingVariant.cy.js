...
describe('Staging Direct Selling', () => {
    ...
    it('add product Direct', () => {
        ...
        // add price Direct selling
        const productPriceDS = faker.commerce.price(2000, 2050, 0)
        cy.get('.published-price > .input-group > .text-input').type(productPriceDS, force)

        // add price Wholesale
        const productPriceWH = faker.commerce.price(2000, 2000, 0)
        ...
        const productSKU1 = `sku-${randomNum1}`
        cy.get(':nth-child(2) > .sku-variant > .text-input').type(productSKU1, force)
        // add location
        ...
        cy.get('.mt-4 > :nth-child(1) > .input-group > .text-input').clear().type(productPriceVariant1, force)
        ...
        const productSKUVar2 = `sku-${randomNum2}`
        cy.get(':nth-child(1) > .flex-grow-1 > .flex-wrap > :nth-child(2) > .sku-variant > .text-input').type(productSKUVar2, force)
        // select location
        ...
        cy.get('.bg-white > .variant-card > .lazada-variant-card > .mt-4 > :nth-child(1) > .input-group > .text-input').clear().type(productPriceVariant2, force)
        ...
        // set price Shopee
        cy.get('.shopee-variant-card > .mt-4 > :nth-child(1) > .input-group > .text-input').clear().type(productPriceVariant2, force)
        ...
        // set price Tokopedia
        cy.get('.tokopedia-variant-card > .mt-4 > :nth-child(1) > .input-group > .text-input').clear().type(productPriceVariant2, force)
        // click add variant
        cy.get('.green-background').click()
